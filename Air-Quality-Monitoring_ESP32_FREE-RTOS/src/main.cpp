...
#define VP_PRESSURE_CALIBRATION 0x5225
#define VP_HUMIDITY_CALIBRATION 0x5235
#define VP_AQI_CALIBRATION      0x5245

// Upper Limit VPs (ASCII, 4 bytes)
#define VP_TEMP_UPPER_LIMIT     0x5112
#define VP_PRESSURE_UPPER_LIMIT 0x5122
#define VP_HUMIDITY_UPPER_LIMIT 0x5132
#define VP_AQI_UPPER_LIMIT      0x5142

// Lower Limit VPs (ASCII, 4 bytes)
#define VP_TEMP_LOWER_LIMIT     0x5115
#define VP_PRESSURE_LOWER_LIMIT 0x5125
#define VP_HUMIDITY_LOWER_LIMIT 0x5135
